...
-- AddForeignKey
ALTER TABLE "knowledge_bases" ADD CONSTRAINT "knowledge_bases_assistantId_fkey" FOREIGN KEY ("assistantId") REFERENCES "chatbot_settings"("id") ON DELETE CASCADE ON UPDATE CASCADE;
