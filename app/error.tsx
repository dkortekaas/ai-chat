    ...
    <div className='h-screen w-full flex flex-col items-center justify-center bg-gray-100'>
      <div className='flex flex-col items-center justify-center'>
        ...
        <div className='mt-8 flex space-x-4'>
          ...
          <Link
            href='/dashboard'
            className='px-6 py-3 rounded-md border border-gray-300 bg-white text-gray-700 font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-declair-blue-500'
          >
