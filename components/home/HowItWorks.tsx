            ...
            return (
              <div key={index} className='relative'>
                <div className='flex flex-col items-center text-center'>
                  <div className='w-16 h-16 bg-declair-blue-400 rounded-full flex items-center justify-center text-white mb-4 relative'>
                    <Icon size={24} />
                    <span className='absolute -top-2 -right-2 w-6 h-6 bg-white text-declair-blue-400 rounded-full flex items-center justify-center text-sm font-bold border-2 border-declair-blue-400'>
                      {index + 1}
                    </span>
                  </div>
