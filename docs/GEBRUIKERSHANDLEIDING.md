# EmbedIQ - Gebruikershandleiding

## 📖 Inhoudsopgave

1. [Introductie](#introductie)
2. [Wat is EmbedIQ?](#wat-is-EmbedIQ)
...
Welkom bij de EmbedIQ gebruikershandleiding! Deze handleiding helpt je om het maximale uit het platform te halen, of je nu een eindgebruiker, beheerder of developer bent.

## Wat is EmbedIQ?

EmbedIQ is een modern, self-hosted chatbot platform waarmee organisaties een AI-gestuurde chatbot kunnen creëren die vragen beantwoordt op basis van hun eigen documenten en kennisbank. Het platform maakt gebruik van geavanceerde AI-technologie (OpenAI GPT-4) en RAG (Retrieval-Augmented Generation) om nauwkeurige en contextbewuste antwoorden te geven.
...
1. **Navigeer naar het platform**: Open je browser en ga naar de URL van je EmbedIQ installatie
...
EmbedIQ heeft drie gebruikersrollen met verschillende toegangsniveaus:
...
Het dashboard is je centrale werkplek in EmbedIQ. Hier vind je:
...
EmbedIQ werkt met een flexibel abonnementssysteem via Stripe.
...
Integreer je EmbedIQ chatbot op elke website.
...
**Q: Ondersteunt EmbedIQ meerdere talen?**
...
EmbedIQ is een krachtig platform voor het creëren van intelligente, document-gestuurde chatbots. Met deze handleiding heb je alle tools en kennis om:
...
- 📧 **Email**: support@EmbedIQ.com (indien geconfigureerd)

---

**Veel succes met EmbedIQ! 🚀**
